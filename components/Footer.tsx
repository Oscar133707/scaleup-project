      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 mb-20">
          <div className="col-span-2">
            ...
            <div className="flex gap-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="w-10 h-10 rounded-full bg-surface border border-borderSubtle flex items-center justify-center hover:bg-accent hover:border-accent transition-colors cursor-pointer group">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-secondary">
              <li className="hover:text-accent transition-colors cursor-pointer">Market Analysis</li>
              <li className="hover:text-accent transition-colors cursor-pointer">Growth Engine</li>
              <li className="hover:text-accent transition-colors cursor-pointer">Design Systems</li>
              <li className="hover:text-accent transition-colors cursor-pointer">Integrations</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-secondary">
              <li className="hover:text-accent transition-colors cursor-pointer">2026 Vision</li>
              <li className="hover:text-accent transition-colors cursor-pointer">Scaling Guide</li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-secondary">
              ...
              <li className="hover:text-accent transition-colors cursor-pointer">Newsroom</li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-secondary">
              ...
              <li className="hover:text-accent transition-colors cursor-pointer">Cookie Settings</li>
              <li className="hover:text-accent transition-colors cursor-pointer">Accessibility</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-borderSubtle flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            ...
            <div className="text-xs font-bold text-secondary tracking-widest uppercase cursor-pointer hover:text-accent transition-colors">
              ENG (US)
            </div>
          </div>
        </div>
